...
begin
  ...
  Usuario := DS_Registro.DataSet.FieldByName('empresa').Text;
...
var
  Assunto, Para : String;
begin
  Assunto := DS_Registro.DataSet.FieldByName('assunto_email').Text;
  ...
  try
    try
     ...
     //Configura os parâmetros necessários para SSL
      ...
      idMsg.From.Name                  := DS_Registro.DataSet.FieldByName('empresa').Text;
